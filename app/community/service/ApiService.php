...
class ApiService {
    ...
    public static function articles($param) {
        ...
        if (!empty($categoryIds)) {
            ...
            array_push($join, ['__COMMUNITY_CATEGORY_ARTICLE__ category_post', 'post.id = category_post.post_id']);
        ...
        $articles = $articleModel->alias('post')->field($field)
                ->join($join)
                ->where($where)
                ->where($paramWhere)
                ->order($order);
    ...
    {
        $portalPostModel = new CommunityArticleModel();
     ...
     */
    public static function artCategory($artId)
    {  
        ...
        $join = [ 
            ['__COMMUNITY_CATEGORY_ARTICLE__ b', 'a.id = b.category_id'] 
        ];
        
        $field = 'a.*, b.category_id, b.id AS post_category_id'; 

        $result =  $communityCategoryModel->alias('a')->field($field)
            ->join($join) 
            ->where($where) 
            ->select(); 
    ...
    public static function category($id) {
        ...
        return $communityCategoryModel->where($where)->find();
    }
    ...
    public static function subCategories($categoryId) {
        ...
        return $communityCategoryModel->where($where)->select();
    }
    ...
    {
        $portalCategoryModel = new CommunityCategoryModel();
